...
import { Star, Check, Shield, Award, CheckCircle, Phone, Home, Wrench, Clock, DoorClosed } from "lucide-react"
            ...
            <div className="text-white space-y-6 lg:space-y-8">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href={quoteHref} aria-label="Book Your Free No-Pressure Consult" data-source="patio-doors-hero" data-offer="100off-per-window">
