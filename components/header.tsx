      ...
      >
        <div className="container mx-auto px-4 py-1">
          <div className="flex items-center justify-between overflow-visible">
            ...
            <nav
              className="header-desktop-nav items-center justify-center gap-8 nav-menu overflow-visible flex-1"
              style={{ alignItems: "center", justifyContent: "center", gap: "12px", overflow: "visible" }}
            >
              <Link
                href="/"
              ...
              <div
                ...
                className="relative group/nav overflow-visible"
                data-dropdown
              ...
              >
                <button
                  ...
                  onKeyDown={(e) => handleKeyDown(e, setIsAboutOpen)}
                >
                  About
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform hidden text-[var(--color-brand-navy)] ${isAboutOpen ? "rotate-180" : ""}`}
                  />
                </button>
                ...
                <div
                  ...
                  className={`absolute left-1/2 -translate-x-1/2 top-full z-[300] w-fit min-w-[140px] rounded-xl border border-border bg-background shadow-lg transition-all duration-150 ease-out ${isAboutOpen ? "visible opacity-100 pointer-events-auto translate-y-0" : "invisible opacity-0 pointer-events-none translate-y-1.5"}`}
                >
                  <div className="absolute -top-[10px] left-0 right-0 h-[10px]"></div>
            ...
            <div className="header-desktop-nav header-cta-container flex flex-row items-center gap-3 z-10">
              {/* Phone Button with Icon */}
              <a
                href={phoneHref}
                className="flex items-center justify-center gap-2 border-2 border-[#049bf2] rounded-xl px-4 py-1.5 hover:bg-[#049bf2] hover:text-white transition-all duration-300 group"
                aria-label="Call Dallas Window Butler for a free estimate"
              >
                <div className="bg-[#049bf2] p-2 rounded-lg group-hover:bg-white transition-colors flex items-center justify-center" style={{ minWidth: '36px', minHeight: '36px' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" style={{ fill: '#ffffff' }} className="group-hover:[&>path]:fill-[#049bf2]">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[9px] uppercase font-bold opacity-80 leading-none mb-0.5 text-[#00152e] group-hover:text-white">
                    Free Estimate
                  </span>
                  <span className="text-sm font-black tracking-tight leading-none whitespace-nowrap text-[#00152e] group-hover:text-white">
                    {phoneDisplay}
                  </span>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center justify-center bg-[#049bf2] hover:bg-[#0389d5] border-2 border-[#049bf2] hover:border-[#0389d5] rounded-xl px-5 py-3 transition-all duration-300"
              >
