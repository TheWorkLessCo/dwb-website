        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="desktop-nav items-center gap-4 ml-auto">
              ...
              >
                <div className="bg-[#049bf2] p-3 rounded-xl group-hover:bg-white transition-colors flex items-center justify-center min-w-[44px] min-h-[44px]">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-white group-hover:fill-[#049bf2]">
