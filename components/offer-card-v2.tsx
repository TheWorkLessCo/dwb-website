  ...
  return (
    ...
    >
      <div className="p-0">
        <div
          ...
          style={{
            ...
            backgroundSize: "contain", // Updated to contain with auto height to show full image without cropping
        ...
        <div
          ...
          style={{
            marginTop: "8px", // Changed from -12px to 8px to add padding between image and buttons
            paddingTop: "0",
            gap: "8px",
            rowGap: "8px",
            display: "flex",
      ...
      <style jsx>{`
        ...
        .offer-cta-group {
          margin-top: 8px !important; // Updated to match inline style
        ...
        @media (max-width: 640px) {
          ...
          .offer-cta-group {
            margin-top: 8px !important; // Updated to match inline style for mobile
            padding-top: 0 !important;
          }
        }
      `}</style>
