...
import { Target, ShieldCheck, Clock, Sparkles, DollarSign } from "lucide-react"
          ...
          {TABS.map((tab, index) => {
            ...
            return (
              <AnimateOnScroll
                ...
                delay={index * 100}
              >
                <div className="group relative bg-white p-8 rounded-[2rem] transition-all duration-500 border border-slate-100 shadow-sm hover:shadow-[0_30px_60px_-15px_rgba(4,155,242,0.15)] hover:-translate-y-3 flex flex-col h-full overflow-hidden">
