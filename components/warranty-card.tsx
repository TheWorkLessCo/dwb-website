...
export function WarrantyCard() {
  return (
    <div className="relative w-full max-w-[460px] animate-in fade-in zoom-in duration-1000 mx-auto lg:mr-0">
      ...
      <div className="bg-white/90 backdrop-blur-xl rounded-[40px] md:rounded-[60px] p-6 md:p-10 shadow-[0_40px_100px_-15px_rgba(4,155,242,0.3)] border border-white/50 flex flex-col items-center text-center relative overflow-visible">
        ...
        {/* Benefit Box */}
        <div className="w-full bg-slate-50/80 backdrop-blur-md border border-slate-200/40 rounded-[30px] md:rounded-[40px] p-5 md:p-8 mb-8 md:mb-10 text-left">
          <h3 className="text-center font-black text-[13px] md:text-[15px] uppercase tracking-[0.2em] text-slate-800 mb-4 md:mb-6 border-b border-slate-200/50 pb-3 md:pb-4">
